import { Canvas2DUtil } from './Core/Cavans2DUtil';
import { CanvasMouseEvent, EInputEventType } from './Core/Event';
import { Inset } from './Math/border';
import { Math2D } from './Math/math2D';
import { vec2 } from './Math/vec2';
import { EOrder, ERenderType, IShape, ISprite } from './SpriteSys/ISprite';
import { Scale9Data } from './SpriteSys/Shape/Scale9Grid';
...
class ShapeDemo {
	...
	public constructor(app: Sprite2DApplication) {
		...
		// 设置要载入的图片 URL 路径
		this._image.src = './resource/scale9.png';
