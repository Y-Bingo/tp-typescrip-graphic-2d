...
import { Rectangle, Size } from "./Math/border";
...
// 文字样式
export type FontType = "10px sans-serif" | "15px sans-serif" | '20px bold sans-serif' | "20px sans-serif" | "25px sans-serif";
...
export class ApplicationTest extends Canvas2DApplication {
    ...
    public setTransform( mat: mat2d ): void {
        if ( this.context2D === null ) return;
        // 将参数矩阵中的各个元素值直接复制到 CanvasRenderContext 上下文渲染对象所持有的的矩阵堆栈中
